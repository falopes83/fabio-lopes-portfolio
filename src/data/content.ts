...
export const dictionary = {
  pt: {
    ...
    contact: {
      ...
      fallbackTitle: 'Seu e-mail foi aberto.',
      fallbackText: 'Revise a mensagem preenchida e envie pelo seu aplicativo de e-mail.',
  ...
  en: {
    ...
    contact: {
      ...
      fallbackTitle: 'Your e-mail app was opened.',
      fallbackText: 'Review the pre-filled message and send it from your e-mail app.',
  ...
  es: {
    ...
    contact: {
      ...
      fallbackTitle: 'Se abrió tu app de e-mail.',
      fallbackText: 'Revisa el mensaje completado y envíalo desde tu aplicación de e-mail.',
